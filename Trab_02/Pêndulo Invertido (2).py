...
V['NEG'] = fuzz.trimf(Velocidade, [-100,-50,0])
V['Z'] = fuzz.trimf(Velocidade, [-50,0,50])
V['POS'] = fuzz.trimf(Velocidade, [0,50,100])
...
A['PB'] = fuzz.trimf(Angulo, [0.2275,0.525,825])
...
# A['ZO'] = fuzz.trapmf(Angulo, [-0.2/div,-0.05/div,0.05/div,0.2/div])
...
S['NVVB'] = fuzz.trapmf(Saida, [-2002,-2000,-1600,-1200])
S['NVB'] = fuzz.trimf(Saida, [-1600,-1200,-800])
S['NB'] = fuzz.trimf(Saida, [-1200,-800,-400])
S['N'] = fuzz.trimf(Saida, [-800,-400,0])
S['Z'] = fuzz.trimf(Saida, [-400,0,400])
S['P'] = fuzz.trimf(Saida, [0,400,800])
S['PB'] = fuzz.trimf(Saida, [400,800,1200])
S['PVB'] = fuzz.trimf(Saida, [800,1200,1600])
S['PVVB'] = fuzz.trapmf(Saida, [1200,1600,2000,2002])
